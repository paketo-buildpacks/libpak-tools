...
- `make test` runs formatting, linting, and tests.
- `make coverage` runs coverage and writes:
  - `coverage.out` (profile)
  - `coverage.txt` (function-level report)

The coverage target excludes packages under folders named `mocks` (auto-generated files) so coverage focuses on hand-written code.
...
Full list of available commands for `libpak-tools`.

```
> libpak-tools --help
A set of tools for managing Paketo libpak based buildpacks

Usage:
  libpak-tools [command]

Available Commands:
  build-jvm-vendors Build JVM Vendors Buildpacks
  completion        Generate the autocompletion script for the specified shell
  dependency        Interact with dependencies
  help              Help about any command
  package           Interact with packages
  version           Print the version number

Flags:
  -h, --help   help for libpak-tools

Use "libpak-tools [command] --help" for more information about a command.
```

### `libpak-tools build-jvm-vendors`

Build the JVM Vendor buildpacks. This is specific to building the Java vendor buildpacks for Paketo.

```
> libpak-tools build-jvm-vendors --help
Build JVM Vendors Buildpacks

Usage:
  libpak-tools build-jvm-vendors [flags]

Flags:
      --buildpack-id stringArray        buildpack id and version in the format 'id@version' (default: all vendors)
      --buildpack-path string           path to jvm-vendors buildpack directory
      --cache-location string           path to cache downloaded dependencies (default: $PWD/dependencies)
      --default-vendor string           default vendor to use, if not set the the configured default vendor or first in the vendor list will be used
      --dependency-filter stringArray   one or more filters that are applied to exclude dependencies, applies to all buildpacks
  -h, --help                            help for build-jvm-vendors
      --include-all-vendors             include all of the vendors (default: false)
      --include-dependencies            whether to include dependencies, applies to all buildpacks (default: false)
      --publish                         publish the buildpack to a buildpack registry, applies to all buildpacks (default: false)
      --registry-name string            prefix for the registry to publish to, applies to all buildpacks (default: the buildpack id)
      --single-buildpack                build output is a single buildpack with listed vendors (default: false)
      --strict-filters                  require filter to match all data or just some data, applies to all buildpacks (default: false)
      --vendors stringArray             list of vendors to build
```

### `libpak-tools dependency`

```
> libpak-tools dependency --help
Interact with dependencies

Usage:
  libpak-tools dependency [command]
...
Use "libpak-tools dependency [command] --help" for more information about a command.
```

### `libpak-tools package`

```
> libpak-tools package --help
Interact with packages

Usage:
  libpak-tools package [command]

Available Commands:
  bundle      Compile and package a single buildpack (component & composite)
  compile     Compile buildpack source code

Flags:
  -h, --help   help for package

Use "libpak-tools package [command] --help" for more information about a command.
```

### `libpak-tools version`

```
> libpak-tools version --help
Print the version number

Usage:
  libpak-tools version [flags]

Flags:
  -h, --help   help for version
```

### `libpak-tools dependency update`

```
> libpak-tools dependency update --help
Update dependencies

Usage:
  libpak-tools dependency update [command]

Available Commands:
  build-image  Update a build image dependency
  build-module Update a build module dependency
  lifecycle    Update a lifecycle dependency
  package      Update a package dependency

Flags:
  -h, --help   help for update

Use "libpak-tools dependency update [command] --help" for more information about a command.
```
...
```
> libpak-tools package bundle --help
...
Flags:
  ...
  -h, --help                            help for compile
      ...
      --strict-filters                  require filter to match all data or just some data (default: false)
      --target-arch string              target architecture for the package (default: all) (default "all")
      --version string                  version to substitute into buildpack.toml/extension.toml
```
...
```
> libpak-tools dependency update build-image --help
...
```
> libpak-tools dependency update build-module --help
...
Flags:
      --arch string               the arch of the dependency
      ...
      --eol-id string             id of the dependency for looking up the EOL date on the https://endoflife.date/
  -h, --help                      help for build-module
      ...
      --source string             the new uri of the dependency source
      --source-sha256 string      the new sha256 of the dependency source
...
```
> libpak-tools dependency update lifecycle --help
...
```
> libpak-tools dependency update package --help
